...
- Enhance the frontend project to add the ability to filter the books by date.
...
backend
ok - Add a graphQL query to the backend service to support filtering books by date.
ok - Add endpoints to enable CRUD operations as needed and integrate these endpoints with the frontend app.
